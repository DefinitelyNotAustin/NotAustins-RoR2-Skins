...
namespace AcridWargreymonCosplay
{
    [R2APISubmoduleDependency(nameof(LoadoutAPI), nameof(LanguageAPI))]
    [NetworkCompatibility(CompatibilityLevel.NoNeedForSync)]
    [BepInDependency("com.bepis.r2api")]
    [BepInPlugin("com.muppp.AcridWargreymonCosplay","Acrid - Wargreymon Cosplay","1.0.0")]
    public partial class AcridWargreymonCosplayPlugin : BaseUnityPlugin
    {
        ...
        {
            BeforeAwake();
            using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("AcridWargreymonCosplay.mupppacridwargreymoncosplay"))
            {
        ...
        private static void ReplaceShaders()
        {
            ...
            materialsWithRoRShader.Add(LoadMaterialWithReplacedShader(@"Assets/Resources/chr027a01.mat", @"Hopoo Games/Deferred/Standard"));
        }
        ...
        {
            LanguageAPI.Add("MUPPP_SKIN_WARGREYMONACRIDSKIN_NAME", "WarGreymon");
            LanguageAPI.Add("MUPPP_SKIN_WARGREYMONACRIDSKIN_NAME", "WarGreymon", "en");
            LanguageAPI.Add("MUPPP_SKIN_WARGREYMONACRIDSKIN_NAME", "ウォーグレイモン", "ja");
        }
        ...
        private static void BodyCatalogInit(On.RoR2.BodyCatalog.orig_Init orig)
        {
            ...
            AddCrocoBodyWargreymonAcridSkinSkin();

            AfterBodyCatalogInit();
        }

        private static void AddCrocoBodyWargreymonAcridSkinSkin()
        {
            var bodyName = "CrocoBody";
            var skinName = "WargreymonAcridSkin";
            try
            {
                ...
                {
                    Icon = assetBundle.LoadAsset<Sprite>(@"Assets\SkinMods\AcridWargreymonCosplay\Icons\WargreymonAcridSkinIcon.png"),
                    Name = skinName,
                    NameToken = "MUPPP_SKIN_WARGREYMONACRIDSKIN_NAME",
                    RootObject = mdl,
                    ...
                    RendererInfos = new CharacterModel.RendererInfo[]
                    {
                        ...
                        new CharacterModel.RendererInfo
                        {
                            defaultMaterial = assetBundle.LoadAsset<Material>(@"Assets/Resources/chr027a01.mat"),
                            defaultShadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.On,
                            ignoreOverlays = false,
                    ...
                    MeshReplacements = new SkinDef.MeshReplacement[]
                    {
                        ...
                        {
                            mesh = assetBundle.LoadAsset<Mesh>(@"Assets\SkinMods\AcridWargreymonCosplay\Meshes\CrocoMesh.mesh"),
                            renderer = renderers[2]
                        },
                        new SkinDef.MeshReplacement
                        {
                            mesh = assetBundle.LoadAsset<Mesh>(@"Assets\SkinMods\AcridWargreymonCosplay\Meshes\ArmorMesh.mesh"),
                            renderer = renderers[3]
                        },
                    },
